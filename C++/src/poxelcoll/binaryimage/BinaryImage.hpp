...
#ifndef POXELCOLL_BINARYIMAGE_BINARYIMAGE_HPP_
#define POXELCOLL_BINARYIMAGE_BINARYIMAGE_HPP_
...
public:
	 ...
	 */
	virtual const bool hasPoint(unsigned int x, unsigned int y) const = 0;

};

}

#endif /* POXELCOLL_BINARYIMAGE_BINARYIMAGE_HPP_ */
