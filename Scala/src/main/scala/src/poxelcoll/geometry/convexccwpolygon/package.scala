...
/** This package deals with convex hulls, polygons and polygon intersection.
  ...
  */
package object convexccwpolygon {

  /** CollisionSegments is a list of CollisionSegment */
  type CollisionSegments = List[CollisionSegment]
  /** The CollisionSegments object is the List object */
  val CollisionSegments = List
}
